    ...
    if (!req.signedCookies.user) {
        ...
        if (!order_id || !change_status) {
            ...
            try {
                ...
                let update_orders_result = await connection.query(update_orders_query, [change_status, order_id]);
                ...
                switch(change_status) {
                    case delivery_start_status: 
                        message_body = '고객님께서 주문하신 상품이 배송을 시작했습니다.'; q_notification_name = '배송이 시작되었습니다.'; break;
                    case delivery_finish_status:
                        message_body = '고객님께서 주문하신 상품이 정상적으로 배달되었습니다.'; q_notification_name = '배송이 완료되었습니다.'; break;
                }
